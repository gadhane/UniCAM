...
class BaseClass:
    ...
    def __init__(
        ...
        if teacher_model:
            ...
            #print(f'Teacher Added to {self.device}')
        else:
    ...
    def train_teacher(
        ...
        plot_losses=True,
        save_model=True,
        save_model_pth="./models/PlantDisease/teacher.pt",
        filename='train.csv'
    ):
        """
        ...
        import pandas as pd
        fields = ['Train Acc', 'Train Loss', 'Val Acc']
        df = pd.DataFrame(list(zip(*[trainacc, loss_arr, valacc])), columns=fields)
    ...
    def _train_student(
        ...
        plot_losses=True,
        save_model=True,
        save_model_pth="./models/PlantDisease/student.pt",
        filename='train.csv',
    ):
        """
        ...
        for ep in range(epochs):
            ...
            for (data, label) in self.train_loader:
                ...
                # for Vit teacher model, you may need to uncomment the following line of Cod.
                # teacher_out = teacher_out.logits
            ...
            if self.log:
                self.writer.add_scalar("Training loss/Student", epoch_loss/length_of_dataset, epochs)
    ...
    def train_student(
        ...
        :param save_model_pth (str): Path where you want to save the student model
        """
        self._train_student(epochs, plot_losses, save_model, save_model_pth, filename)
